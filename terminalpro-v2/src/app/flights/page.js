...
const INITIAL_VISIBLE_COLUMNS = ["airline", "aircraft", "flight_number", "origin", "departure_time", "destination", "arrival_time", "actions"];
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">Total {flights.length} flights</span>
                            ...
                            <DrawerBody className="h-full">
                                <div className="flex flex-col items-center">
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Id:</div>
                                        <div>{activeFlight.id}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Airline:</div>
                                        <div>{activeFlight.airline}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Aircraft:</div>
                                        <div>{activeFlight.aircraft}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Flight Number:</div>
                                        <div>{activeFlight.flight_number}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Origin:</div>
                                        <div>{activeFlight.origin}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Departure Time:</div>
                                        <div>{new Date(activeFlight.departure_time).toLocaleString()}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Departure Gate:</div>
                                        <div>{activeFlight.departure_gate}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Destination:</div>
                                        <div>{activeFlight.destination}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Arrival Time:</div>
                                        <div>{new Date(activeFlight.arrival_time).toLocaleString()}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Arrival Gate:</div>
                                        <div>{activeFlight.arrival_gate}</div>
                                    </div>
                                    <div className="flex w-full">
                                        <div className="w-36 font-medium">Crew:</div>
                                        <div className="flex flex-col">
                                            {activeFlight.crew.map((member, index) => (
